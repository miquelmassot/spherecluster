...
print(
    "Adjusted Mututal Information: %.3f"
    % metrics.adjusted_mutual_info_score(labels, km.labels_)
)
print(
    "Silhouette Coefficient (euclidean): %0.3f"
    % metrics.silhouette_score(X, km.labels_, metric="euclidean")
)
print(
    "Silhouette Coefficient (cosine): %0.3f"
    % metrics.silhouette_score(X, km.labels_, metric="cosine")
)
...
print("Adjusted Rand-Index: %.3f" % metrics.adjusted_rand_score(labels, skm.labels_))
print(
    "Adjusted Mututal Information: %.3f"
...
vmf_soft = VonMisesFisherMixture(
    ...
    init="random-class",
    n_init=20,
    force_weights=np.ones((true_k,)) / true_k,
)
...
print(
    "Adjusted Rand-Index: %.3f" % metrics.adjusted_rand_score(labels, vmf_soft.labels_)
)
print(
    "Adjusted Mututal Information: %.3f"
...
print(
    "Adjusted Rand-Index: %.3f" % metrics.adjusted_rand_score(labels, vmf_hard.labels_)
)
print(
    "Adjusted Mututal Information: %.3f"
