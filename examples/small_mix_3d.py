...
ax.scatter(
    X[km.labels_ == km_mu_0_idx, 0],
    X[km.labels_ == km_mu_0_idx, 1],
    X[km.labels_ == km_mu_0_idx, 2],
    c="r",
)
ax.scatter(
    X[km.labels_ == km_mu_1_idx, 0],
    X[km.labels_ == km_mu_1_idx, 1],
    X[km.labels_ == km_mu_1_idx, 2],
    c="b",
)
ax.set_aspect("equal")
...
ax.scatter(
    X[skm.labels_ == skm_mu_0_idx, 0],
    X[skm.labels_ == skm_mu_0_idx, 1],
    X[skm.labels_ == skm_mu_0_idx, 2],
    c="r",
)
ax.scatter(
    X[skm.labels_ == skm_mu_1_idx, 0],
    X[skm.labels_ == skm_mu_1_idx, 1],
    X[skm.labels_ == skm_mu_1_idx, 2],
    c="b",
)
ax.set_aspect("equal")
...
ax.scatter(
    X[vmf_soft.labels_ == vmf_soft_mu_0_idx, 0],
    X[vmf_soft.labels_ == vmf_soft_mu_0_idx, 1],
    X[vmf_soft.labels_ == vmf_soft_mu_0_idx, 2],
    c="r",
)
ax.scatter(
    X[vmf_soft.labels_ == vmf_soft_mu_1_idx, 0],
    X[vmf_soft.labels_ == vmf_soft_mu_1_idx, 1],
    X[vmf_soft.labels_ == vmf_soft_mu_1_idx, 2],
    c="b",
)
ax.set_aspect("equal")
...
ax.scatter(
    X[vmf_hard.labels_ == vmf_hard_mu_0_idx, 0],
    X[vmf_hard.labels_ == vmf_hard_mu_0_idx, 1],
    X[vmf_hard.labels_ == vmf_hard_mu_0_idx, 2],
    c="r",
)
ax.scatter(
    X[vmf_hard.labels_ == vmf_hard_mu_1_idx, 0],
    X[vmf_hard.labels_ == vmf_hard_mu_1_idx, 1],
    X[vmf_hard.labels_ == vmf_hard_mu_1_idx, 2],
    c="b",
)
ax.set_aspect("equal")
